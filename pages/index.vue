...
.widgetmini1094 {
  ...
  /* 2xl:h-48 absolute 2xl:-translate-y-16 2xl:translate-x-96 */
}

.widget01 {
  height: 48rem;
  position: absolute;
  transform: translate(-2.2rem, -13rem);
}
...
.widget330 {
  height: 48rem;
  position: absolute;
  transform: translate(-14rem, -20rem);
}
...
@media (max-width:1441px) {
  .widget01 {
    height: 32rem;
    position: absolute;
    transform: translate(-1.8rem, -13rem);
  }
