<template>
  <div class="w-full mt-24 flex flex-col-reverse md:flex-row items-center px-8 lg:px-12 xl:px-20 2xl:px-32">
    ...
    <div class="w-full sm:w-11/12 md:w-1/2 xl:w-2/5 ml-0 md:ml-8 2xl:ml-20 text-xl text-quaternary font-light">
      <p class="text-sm">Video Review</p>
      <h1 class="text-3xl font-extralight mt-1">Canabliss Oasiz :</h1>
      <h2 class="text-3xl font-normal text-primary">Super Berry Hydrating Mask</h2>
      <div class="w-full flex items-center mt-3 xl:mt-6">
        <div class="h-32 w-4 bg-primary mr-4"></div>
      ...
      <BaseButton class="mt-4 xl:mt-12">View more</BaseButton>
    </div>
  </div>
</template>
