<template>
  <div class="w-full flex flex-col justify-center px-24 lg:px-12 xl:px-20 2xl:px-36">
    <p class="text-primary text-7xl">FAQ</p>
    <div class="w-full flex flex-row justify-center items-center my-6">
      <!-- Dropdown FQA -->
      <div class="w-1/2 flex flex-col mr-8">
        ...
        <base-dropdown class="my-6" dropdownClass="mt-2" @opened="checkDataOpen" openUp="toggle" >
          ...
          <!-- Details -->
          <base-dropdown-item>
            <p class="w-11/12 text-sm xl:text-xl text-quaternary ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum sequi
      ...
      <!-- Picture-->
      <div class="w-1/2 mt-8 xl:mt-0 flex justify-center items-center">
