<template>
  <div class="w-full">
    ...
    <div v-else class="w-full">
          ...
          <div class="w-full flex-col text-2xl text-primary">
            ...
            <div class="w-full flex mt-6">
              <a class="flex items-center justify-center" :href="products_id.link"><button
                  class="px-4 h-10 text-lg text-quaternary border border-quaternary rounded-full mr-1">Go to
                  shopping</button></a>
              <div @click="liked(i)"
      ...
      <!-- More detail -->
      <div class="w-full mt-16 sm:mt-28 relative px-4 lg:px-12 xl:px-28 3xl:px-32">
        ...
        <div class="content w-full flex pb-4 lg:pb-0 z-20">
          <div class="w-full flex flex-col md:flex-row justify-evenly items-center z-20 px-4 lg:px-12 xl:px-28 3xl:px-32">
            ...
            <div class="w-full mt-4 sm:mt-0 md:w-2/5 flex flex-col items-center justify-center">
              ...
              <h1 class="text-lg 3xl:text-2xl text-center font-normal">Leucojum Aestivum Bulb Extract <br class="block sm:hidden"> (Ibr - Snowflake®)</h1>
