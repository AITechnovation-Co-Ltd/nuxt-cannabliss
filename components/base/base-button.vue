<template>
  <button
    class="h-14 text-quaternary text-2xl hover:text-white hover:bg-tertiary px-4 flex justify-between items-center border-2 hover:border-tertiary border-quaternary rounded-full"
