<template>
  <div class="w-full text-quaternary flex flex-col justify-center items-center mt-12 px-8 sm:px-12 lg:px-16 xl:px-20 2xl:px-32 z-20">
    ...
    <p class="w-full xl:w-2/3 my-8 text-center text-sm font-extralight">Sed ut perspiciatis unde omnis iste natus error sit voluptatem
    ...
    <div class="w-full flex flex-col mt-6 sm:mt-12 lg:flex-row justify-between items-center">
