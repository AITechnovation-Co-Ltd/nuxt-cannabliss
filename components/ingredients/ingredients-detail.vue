    ...
    <div class="w-full flex flex-col mt-0 sm:mt-4 lg:mt-0 lg:flex-row justify-between items-center">
      <div class="w-full sm:w-5/6 lg:w-1/2 xl:w-2/5 lg:mr-8 xl:mr-0">
        ...
        <div class="flex items-center mt-4">
          <div class="w-1.5 h-24 2xl:h-20 bg-primary mr-4 flex"></div>
          <span class="text-quaternary font-bold text-lg sm:text-xl">By having a hero ingredient , there's an opportunity to get
            into the SKINCARE TREND in Thailand</span>
        </div>
        <p class="mt-4 text-justify text-quaternary">Leucojum aestivum bulb extract ( IBR - Snowflake ) is part of the anti aging
      ...
      <div class="w-full sm:w-5/6 lg:w-1/2 h-full mt-8 lg:mt-0 relative">
    ...
    <div class="w-full mt-28 relative">
      ...
      <div class="content w-full flex pb-4 lg:pb-0 z-20">
        <div class="w-full text-quaternary flex flex-col md:flex-row justify-evenly items-center z-20">
          ...
          <div class="w-0.5 h-60 xl:h-72 2xl:h-76 bg-primary hidden md:block"></div>
          <div class="w-full md:w-2/5 flex flex-col items-center justify-center">
