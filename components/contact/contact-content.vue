<template>
  <div class="w-full flex flex-col justify-center text-3xl px-24 lg:px-12 xl:px-20 2xl:px-36">
    <div class="w-full">
      <!-- Breadcrumb -->
        ...
        <ol class="text-quaternary text-base inline-flex items-center justify-center space-x-1 md:space-x-3">
          ...
          <li aria-current="page">
            <div class="flex items-center">
              ...
              <p class="font-extrabold md:ml-2 ">Contact</p>
            </div>
          </li>
        </ol>
      </nav>
    ...
    <div class="flex flex-col lg:flex-row">
      <!-- Details Contract -->
      <div class="w-full lg:w-1/2 flex flex-col my-8">
        <a class="flex items-center " href="https://goo.gl/maps/ndXssawVBm4sNwf96" target="_blank">
          <base-icon viewBox="0 0 153 154" icon="location" class="w-20 h-20 mr-4" />
          <p class="text-lg lg:text-xl 2xl:text-2xl text-quaternary font-light">2922 / 209-214, Charn Issara Tower 2,12A
      ...
      <div class="w-full lg:w-1/2 flex flex-col items-center">
        <p class="mb-8 text-4xl 2xl:text-5xl text-primary">Have some questions ?</p>
        <a href="https://lin.ee/i5MkM6w" target="_blank">
          <img src="~/static/images/IMG_05contacts/qrline.png" alt="">
        </a>
        <p class="mt-4">Or click <a href="https://lin.ee/i5MkM6w" target="_blank" class="text-primary hover:underline">this</a> to add line</p>
      </div>
    </div>
  </div>
</template>
